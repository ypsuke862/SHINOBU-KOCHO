...
let handler = async (_0x55976e, {
    ...
    try {
        ...
        if (!_0x55976e[_0x2359c0(0x1bb)]) return m.reply('_Responde a una *Imagen.*_')
        ...
        return m.reply('_Necesitas una *Imagen.*_')
    }
};
handler.command = ['setbotpfp']
handler.owner = true 
export default handler;

function _0x14c2() {
    const _0x1897e4 = ['AUTO', 'user', '8CJixwu', 'getHeight', 'getBufferAsync', 'w:profile:picture', '_Foto cambiada con exito._', 'picture', 'read', '1419731ZjYevm', 'MIME_JPEG', '82272azbcaw', '350agtQLJ', '279gQMikZ', 'mimetype', '188728rlRvtO', 'msg', 'jid', 'image', '1705364hxGRFM', '14905ZvBfug', '2578255zmHnCy', 'getWidth', 'reply', '1780230pdlTpE', 'download', 'quoted', 'query', '2810ZHRQDi', 'resize', '_Responde a una *Imagen.*_', 'rowner']
    _0x14c2 = function () {
        return _0x1897e4;
    };
    return _0x14c2();
